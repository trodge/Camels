...
void Settings::load(const fs::path &p) {
    ...
    loadColor("ui.highlight", &uIHighlight, {0, 127, 255}, tree);
    loadColor("ui.routeColor", &routeColor, {96, 72, 72}, tree);
    loadColor("ui.dotColor", &dotColor, {108, 64, 64}, tree);
    loadColor("ui.waterColor", &waterColor, {24, 110, 150}, tree);
    ...
    fightFontSize = tree.get("ui.fightFontSize", 24);
    equipFontSize = tree.get("ui.equipFontSize", 24);
    townFontSize = tree.get("ui.townFontSize", 22);
    tradeFontSize = tree.get("ui.tradeFontSize", 18);
