...
void Settings::load(const fs::path &p) {
    ...
    loadColor("ui.background", &uIBackground, {109, 109, 109}, tree);
    loadColor("ui.highlight", &uIHighlight, {0, 127, 251}, tree);
    loadColor("ui.routeColor", &routeColor, {97, 97, 97}, tree);
    loadColor("ui.waterColor", &waterColor, {29, 109, 149}, tree);
    loadColor("ui.playerColor", &playerColor, {255, 255, 255}, tree);
    loadColor("ui.aIColor", &aIColor, {191, 191, 191}, tree);
    ...
    bigBoxFontSize = tree.get("ui.bigBoxFontSize", 42);
    loadBarFontSize = tree.get("ui.loadBarFontSize", 30);
    smallBoxBorder = tree.get("ui.smallBoxBorder", 3);
    smallBoxRadius = tree.get("ui.smallBoxRadius", 5);
    smallBoxFontSize = tree.get("ui.smallBoxFontSize", 20);
    fightFontSize = tree.get("ui.fightFontSize", 22);
    equipFontSize = tree.get("ui.equipFontSize", 18);
    townFontSize = tree.get("ui.townFontSize", 16);
    tradeFontSize = tree.get("ui.tradeFontSize", 16);
