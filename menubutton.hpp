...
class MenuButton : virtual public TextBox {
  ...
  public:
    MenuButton(const SDL_Rect &rt, const std::vector<std::string> &t, const SDL_Color &fg, const SDL_Color &bg, unsigned int i, bool iN, int b,
               int r, int fS, SDL_Surface *img, const std::function<void()> &oC);
    MenuButton(const SDL_Rect &rt, const std::vector<std::string> &t, const SDL_Color &fg, const SDL_Color &bg, unsigned int i, bool iN, int b,
               int r, int fS, const std::function<void()> &oC)
        : MenuButton(rt, t, fg, bg, i, iN, b, r, fS, nullptr, oC) {}
    MenuButton(const SDL_Rect &rt, const std::vector<std::string> &t, const SDL_Color &fg, const SDL_Color &bg, int b, int r, int fS,
               SDL_Surface *img, const std::function<void()> &oC)
